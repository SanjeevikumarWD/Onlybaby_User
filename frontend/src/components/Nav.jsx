        ...
        >
          ...
          {activeMenu === "age" && (
            <div className="p-5 w-full">
              ...
              <ul className="space-y-4">
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handleAgeRangeClick('0-1'); navigate('/product'); }}>
                  0 - 1 years
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handleAgeRangeClick('1-3'); navigate('/product');}}>
                  1 - 3 years
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handleAgeRangeClick('3-6'); navigate('/product');}}>
                  3 - 6 years
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handleAgeRangeClick('6-11'); navigate('/product');}}>
                  6 - 11 years
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handleAgeRangeClick('11-19'); navigate('/product');}}>
                  11 - 19+ years
                </li>
              </ul>
            </div>
          ...
          {activeMenu === "price" && (
            <div className="p-5 w-full">
              ...
              <ul className="space-y-4">
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handlePriceRangeClick('0-200');navigate('/product')}}>
                  Below ₹200
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handlePriceRangeClick('200-500');navigate('/product')}}>
                  ₹200 - ₹500
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handlePriceRangeClick('500-1000');navigate('/product')}}>
                  ₹500 - ₹1000
                </li>
                <li className="font-regular text-2xl cursor-pointer flex items-center gap-5 text-slate-500 active:text-black active:bg-slate-300 p-2 transition-colors duration-100" onClick={() => {handlePriceRangeClick('1000-2000');navigate('/product')}}>
                  Above ₹1000
                </li>
              </ul>
            </div>
